...
#!/usr/bin/env python
#title           :problem036.py
#description     :Daily coding 36 medium .refer bst-pre-in-post-traverse.py
...
#---------NOTE : IMP : --------------------------------------------------------------
# Second largest element in BST ==Second last element in inorder traversal  OR
# Second largest element in BST ==second element in reverse inorder traversal. 
#-------------------------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    secondLargets = str(bt.INORDER).split(' ')[-2]
    print('Second largest element in BST is : %r' %secondLargets)
