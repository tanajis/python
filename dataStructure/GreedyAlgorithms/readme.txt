...
--Easy  to come up with a greedy algorithm  for a problem.
--Analyzing the run time  will generally be much easier than for other techniques 
--It is hard to prove why it is correct. 
